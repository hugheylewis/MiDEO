...
def message_window():
    ...
    win.title('Help Menu')
    message = ("1. Navigate to https://security.microsoft.com\n2. Go to Devices\n3. Use the Device page's search bar "
               "to find devices to offboard\n4. Check the box next to each device and click Export.\nNOTE: Do not "
               "change the format of the exported CSV file.\n5. Click the Open button and select the exported CSV "
               "file.\n6. Verify the list of devices is correct within the 'CSV File Input' window. Additionally, "
               "verify the file and total number of devices to offboard is correct underneath the 'Offboarding "
               "Status' window.\n7. Click the Offboard button. Any error messages generated by the Microsoft API will "
               "apear in the 'Offboarding Status' window.")
    tkinter.Label(win, text=message).grid()
    tkinter.Button(win, text='OK', width=10, command=win.destroy).grid()
